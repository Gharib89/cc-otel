...
uv run python -m tools.matview_sync --name <slug>  # author: edited canonical file -> generated migration (matview DROP+CREATE; view/function CREATE OR REPLACE, no DROP; git-HEAD down body); then dev-migrate.sh regenerates schema.sql
