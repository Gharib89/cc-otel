...
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'subagent_completed', 'model_swapped', 'kept', NULL, NULL, 'Whether the subagent''s model changed mid-run.', NULL, '2026-07-29', 'kept basis constant (#370): `False` on all 794 records in the profiled window (promotion-candidate-profile.md, *Settled by the evidence*); re-measured 2026-07-29 over 2026-07-14..28 -- still one value');
