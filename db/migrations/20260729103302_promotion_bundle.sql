...
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'assistant_response', 'message.uuid', 'kept', NULL, NULL, 'Message UUID.', NULL, '2026-07-29', '#359: covered by the promoted prompt_id, which reaches all three families');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'feedback_survey', 'event_origin', 'kept', NULL, NULL, 'Where the survey event originated.', NULL, '2026-07-29', '#370: surfaced by the post-#369 sweep with no group verdict; the whole feedback_survey family answers Anthropic''s question about survey uptake (#359)');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'feedback_survey', 'event_origin_server', 'kept', NULL, NULL, 'Server that originated the survey event.', NULL, '2026-07-29', '#370: surfaced by the post-#369 sweep with no group verdict; same family reading');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'subagent_completed', 'final_model', 'kept', NULL, NULL, 'Model the subagent finished on.', NULL, '2026-07-29', '#358: api_request already carries `model` alongside the agent-bearing query_source, so model-per-agent exists at request grain');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'subagent_completed', 'model_swapped', 'kept', NULL, NULL, 'Whether the subagent''s model changed mid-run.', NULL, '2026-07-29', '#370: surfaced by the post-#369 sweep with no group verdict; no report states a rate it is the numerator of, so the near-zero-counter rule (#359) lands it kept');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'tool_decision', 'tool_source', 'kept', NULL, NULL, 'Where the tool came from (builtin/mcp/sdk_host_builtin_mcp).', NULL, '2026-07-29', '#358: redundant with the promoted tool_name=''mcp_tool'' -- 1,027 rows both ways, adds 34 of 49,250 (0.07%)');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('events', 'user_prompt', 'message.uuid', 'kept', NULL, NULL, 'Message UUID.', NULL, '2026-07-29', '#359: covered by the promoted prompt_id');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('metrics', 'claude_code.cost.usage', 'mcp_server.name', 'kept', NULL, NULL, 'MCP server attribution.', NULL, '2026-07-29', '#358: exactly redundant with raw.events.api_request -- 20 (server, tool) pairs both sides, 0 either-only, cost within 0.04%');
INSERT INTO meta.column_registry (signal, signal_name, attr_path, status, column_name, data_type, description, useful_for, decided_at, notes) VALUES ('metrics', 'claude_code.cost.usage', 'mcp_tool.name', 'kept', NULL, NULL, 'MCP tool attribution.', NULL, '2026-07-29', '#358: same pair; promoting would mint a second, ambiguous MCP-cost path (ADR-0008)');
